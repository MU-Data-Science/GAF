...
;;
;; I included this code to be able to do 'HTTP Digest authentication'.
;; In addition to the original module, I added 'md5-from-string' as a
;; convenience for the digest authentication use-case.
;;; Code:
