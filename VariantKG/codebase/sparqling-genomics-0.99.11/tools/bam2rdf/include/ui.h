...
int32_t ui_print_bam_file_error (const char *file_name);
int32_t ui_print_bam_header_error (const char *file_name);
...
void ui_print_bam_unknown_header (const char *header_item);
