...
ontology_init (ontology_t **ontology_ptr)
{
  ...
  register_prefix (PREFIX_BAM_HEADER,        STR_PREFIX_BAM_HEADER,        "hd");
  register_prefix (PREFIX_BAM_REFERENCE_SEQ, STR_PREFIX_BAM_REFERENCE_SEQ, "sq");
  register_prefix (PREFIX_BAM_READ_GROUP,    STR_PREFIX_BAM_READ_GROUP,    "rg");
  register_prefix (PREFIX_BAM_PROGRAM,       STR_PREFIX_BAM_PROGRAM,       "pg");
  register_prefix (PREFIX_BAM_COMMENT,       STR_PREFIX_BAM_COMMENT,       "co");
  ...
  define_class (ontology, CLASS_BAM_HEADER,             PREFIX_BASE,   "HeaderItem");
  define_class (ontology, CLASS_BAM_REFERENCE_SEQ,      PREFIX_BASE,   "ReferenceSequence");
  define_class (ontology, CLASS_BAM_READ_GROUP,         PREFIX_BASE,   "ReadGroup");
  define_class (ontology, CLASS_BAM_PROGRAM,            PREFIX_BASE,   "Program");
  define_class (ontology, CLASS_BAM_COMMENT,            PREFIX_BASE,   "Comment");
  define_class (ontology, CLASS_BAM_READ,               PREFIX_BASE,   "SequencingRead");
